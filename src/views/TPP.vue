  ...
  >
    <template v-slot:top>
      <v-toolbar flat color="white" class="mt-2 mb-2">
        <v-toolbar-title style="color: #30475e;">Transaksi Produk</v-toolbar-title>
        <v-divider
          class="mx-4"
          inset
          vertical
        ...
        <v-dialog v-model="dialog" max-width="500px">
          <template v-slot:activator="{ on }">
            ...
            <v-btn class="mr-1"  dark color="#f2a365" v-on="on" to="/menu/tpp-list">
    ...
    <template v-slot:footer>
       <v-toolbar flat color="white" class="mt-8 mb-2 ml-12">
        ...
        <v-spacer/>
        <v-btn class="px-10 mr-12 py-5" dark color="#f2a365" @click="buka">Buat Transaksi</v-btn>
       </v-toolbar>
    </template>
  </v-data-table>
</template>
