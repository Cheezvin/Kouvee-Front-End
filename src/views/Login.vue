        ...
        <v-row align="center" justify="center">
          <v-col cols="12" sm="8" md="4" >
            <v-card class="elevation-12">
              <v-toolbar color="#30475e" dark flat>
                <v-spacer/>
              ...
              <v-card-text>
                <v-form>
                    ...
                    <v-text-field color="#f2a365" v-model="name" class="subtitle-2" label="Nama" name="login" type="text"/>  
                    <v-icon>mdi-lock</v-icon>
                    <v-text-field color="#f2a365" v-model="pass" class="subtitle-2" label="Password" name="password" type="password"/>
                </v-form>
              </v-card-text>
              <v-card-actions>
                <v-spacer />
                <v-btn color="#f2a365" dark class="mb-3 py-4 px-4" @click="login">Login</v-btn>
                <v-spacer />
              </v-card-actions>
            </v-card>
          </v-col>
